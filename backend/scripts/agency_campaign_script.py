...
Then: "You're hearing the same system sales teams use to book qualified meetings automatically."
Pause briefly.
Then: "Most people only have one question after this — does it actually work for my sales team?"
Go to STATE 3.
...
Then: "It doesn't replace your sales team — it removes the manual outreach layer and only delivers qualified, high-intent conversations your team can actually close."
...
"How much does it cost?": "Most sales teams start around $199 a month for the platform, plus you pay Twilio and ElevenLabs directly for usage — usually $100-150 total. Way less than one SDR."
...
"Not the right time": "Totally understand. Quick question though — is it timing, or is there something specific holding you back? Because most sales teams that say 'later' end up watching competitors adopt it first."
...
Then: "It's whether you want to start using it to generate and qualify pipeline for your sales team right now, or later once others in your space adopt it first."
Go to STATE 7.
...
If MAYBE: "No pressure. Most sales teams start with a small test — light volume, prove conversion, then scale. Want to start there?"
